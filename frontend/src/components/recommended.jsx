...
function Recommended(props) {
    ...
    useEffect(() => {
        setData(setState, state, "api/recommended_my_styles/" + (location.search ? location.search : ""));
    }, [location]);
        ...
        <div className="container-xxl py-5">
            <div className="container">
                <div className="text-center mx-auto mb-5 wow fadeInUp title-products" data-wow-delay="0.1s">
                    <h2 className="d-inline-block bg-secondary text-primary-2 py-1 px-4">استایل های مناسب شما</h2>
                    {/* 
